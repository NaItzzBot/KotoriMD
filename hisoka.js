...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
            ...
            break
            case 'sc': {
                m.reply('Script Recode By : https://github.com/NaItzzBot/KotoriMD\n\n Dont Forget Give Star\nBase By : https://github.com/DikaArdnt/Hisoka-Morou')
            }
            break
            case 'chat': {
...
⭔ Detail: ${detail}`
            ...
            let btn = [{
                                ...
                                urlButton: {
                                    ...
                                    url: 'https://github.com/NaItzzBot'
...
1. Jangan Spam Bot
SANKSI: Blok Permanen

2. Jangan Telepon Bot
SANKSI: Blok Permanen

3. Jangan Jual Bot Ini
SANKSI: Blok Permanen

Bot ini adalah bot garapan ${nameowner} dan sc ini diambil dari
base milik DikaArdnt dan sc boleh digunakan oleh siapapun 
yang ingin ngebot dan ingin belajar membuat bot sendiri.

*JADI JANGAN COBA COBA JUAL SC INI!!*`
 let btn = [{
                                urlButton: {
                                    displayText: 'Source Code',
                                    url: 'https://github.com/NaItzzBot/KotoriMD'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
